...
public class TesteTrechosCompostos {
	...
	@Test
	public void testeTrechoComEscala() {
	...
	public void testeTrechoComEscalaAeroportosDiferentes() {
	...
	@Test
	public void testeTrechoComConexao() {
		TrechoAereo t1 = new TrechoAereoSimples("GRU", "FOR", 200, 400);
		TrechoAereo t2 = new TrechoAereoSimples("FOR", "NAT", 150, 200);
	...
	@Test
	public void testeTrechoComEscalaEConexao() {
		TrechoAereo t1 = new TrechoAereoSimples("GRU", "FOR", 200, 400);
		TrechoAereo t2 = new TrechoAereoSimples("FOR", "NAT", 150, 200);
		TrechoAereo escala = new TrechoAereoComEscala(t1,t2);
